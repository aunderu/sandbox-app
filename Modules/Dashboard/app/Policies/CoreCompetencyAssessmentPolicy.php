...
class CoreCompetencyAssessmentPolicy
{
     ...
     */
    public function view(User $user, CoreCompetencyAssessmentModel $assessment): bool
    {
     ...
     */
    public function update(User $user, CoreCompetencyAssessmentModel $assessment): bool
    {
     ...
     */
    public function delete(User $user, CoreCompetencyAssessmentModel $assessment): bool
    {
     ...
     */
    public function restore(User $user, CoreCompetencyAssessmentModel $assessment): bool
    {
     ...
     */
    public function forceDelete(User $user, CoreCompetencyAssessmentModel $assessment): bool
    {
